...
export const TxHashDiv : FC <props> = ({
    ...
    const div = () =>{
        ...
        if (txHash instanceof Error){
            ...
            return <CommonMessageDiv className="text-left w-4/5 p-2 bg-red-600 text-gray-100 rounded-2xl mb-2"
            transitionDuration={0.32}>{txHash.message}</CommonMessageDiv>
        }
        else {
    
            return <CommonMessageDiv className="text-left w-4/5 p-2 bg-cyan-800 text-gray-100 rounded-2xl mb-2"
